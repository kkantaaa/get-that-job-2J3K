        ...
        <div className="flex flex-col ml-[220px] mt-[96px] mr-[776px]">
          ...
          <div className="flex flex-row">
            <div className="flex flex-col font-Inter text-LightGray">
              <h2
                className="text-[14px] font-normal leading-5 tracking-[1.25px] mr-[12px]"
            ...
            <div className="flex flex-col font-Inter">
              <h2 className="text-[14px] font-medium leading-5 tracking-[1.25px]">
                RECRUITER
              </h2>
...
export default RecruitRegisterPage1;
